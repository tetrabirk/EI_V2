 ...
 */
final class Version20181115184724 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE work_day (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, site_id INT NOT NULL, date DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_9FCE7E0CF675F31B (author_id), INDEX IDX_9FCE7E0CF6BD1646 (site_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
