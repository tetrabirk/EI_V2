 ...
 */
final class Version20190127123457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE admin (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE completed_task (id INT AUTO_INCREMENT NOT NULL, task_id INT DEFAULT NULL, worker_id INT DEFAULT NULL, workday_id INT NOT NULL, duration TIME NOT NULL, INDEX IDX_36FC2E198DB60186 (task_id), INDEX IDX_36FC2E196B20BA36 (worker_id), INDEX IDX_36FC2E19AB01D695 (workday_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE completed_task ADD CONSTRAINT FK_36FC2E19AB01D695 FOREIGN KEY (workday_id) REFERENCES work_day (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE completed_task DROP FOREIGN KEY FK_36FC2E19AB01D695');
