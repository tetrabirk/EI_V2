...
//TODO make function out of this
     ...
     * @return Response
     */
    public function newWorkDayStepTwo(Request $request, Registry $workflows, $workday):Response
    {
...
//            }
     ...
     * @return Response
     */
    public function newWorkDaySummary(Registry $workflows):Response
    {
        $wdr = $this->getRepo();
        $id = $_POST['work_day']['id'];
        $workday = $wdr->find($id);
